          ...
          <>
            ...
            <div className="border-t border-black pt-2 sm:pt-3">
              ...
              <div className="bg-[#FFE66D] border border-black p-3 mb-3 text-xs sm:text-sm">
                <p>Complex DSP with an extrememly simple interface for all budgets. Suggested prices help support ongoing development. Every contribution helps us keep creating tools you&apos;ll love.</p>
              </div>
