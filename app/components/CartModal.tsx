          ...
          <>
                      ...
                      {plugin.price === 0 ? (
                        ...
                        <div className="space-y-1">
                          <p className="text-xs text-gray-600">
                            Suggested: ${plugin.price} {minPrice > 0 && `(minimum: $${minPrice})`}
                          </p>
            ...
            <div className="border-t border-black pt-2 sm:pt-3">
              ...
              <div className="bg-[#FFE66D] border border-black p-3 mb-3 text-xs sm:text-sm">
                <p>Complex DSP with an extremely simple interface for all budgets. Suggested prices help us keep creating tools you&apos;ll love.♥️</p>
              </div>
              ...
              {/* Payment Method Selector - DISABLED: PayPal requires support contact */}
              {/* PayPal account setting "Accept payments before API setup" was enabled */}
              {/* but payments still fail with TRANSACTION_REFUSED */}
              {/* User needs to contact PayPal Business Support: 1-888-221-1161 */}
              {/* Reference Debug ID: 168e734e9b504 */}
              {/* <div className="mb-3 sm:mb-4">
