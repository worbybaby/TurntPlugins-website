...
const files = [
  ...
  { path: `${MAC_DIR}/TapeBloom_v1.1.1.pkg`, name: 'TapeBloom_v1.1.1.pkg', platform: 'macOS' },
  ...
  { path: `${WINDOWS_DIR}/TapeBloom-v1.1.1-Windows-x64.exe`, name: 'TapeBloom-v1.1.1-Windows-x64.exe', platform: 'Windows' },
